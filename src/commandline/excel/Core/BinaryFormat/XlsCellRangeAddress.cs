...
namespace Excel.Core.BinaryFormat
{
    internal class XlsCellRangeAddress
    {
        ...
        public int FirstRow
        {
            get
            {
                return (int)BitConverter.ToInt16(m_bytes, m_offset+0);
            }
        }
        public int LastRow
        {
            get
            {
                return (int)BitConverter.ToInt16(m_bytes, m_offset+2);
            }
        }
        public int FirstColumin
        {
            get
            {
                return (int)BitConverter.ToInt16(m_bytes, m_offset+4);
            }
        }
        public int LastColumin
        {
            get
            {
                return (int)BitConverter.ToInt16(m_bytes, m_offset+6);
            }
        }
